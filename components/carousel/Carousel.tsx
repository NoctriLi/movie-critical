...
const Carousel: React.FC<Movies> = (movies) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto w-8/12  overflow-hidden after:clear-both after:block after:content-['']">
        ...
        {movies.results.map((movie: Movie) => (
          ...
          {...(movie.id==movies.results[0].id?{'data-te-carousel-active': true}:null)}
          data-te-carousel-item
        >
          <img src={"https://image.tmdb.org/t/p/w500" + movie.backdrop_path} className="block w-full" alt="..." />
