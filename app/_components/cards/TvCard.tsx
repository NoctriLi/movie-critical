...
const TvCard: React.FC<TVShow> = (tvshow) => {
  ...
  return (
    <div className="relative min-w-[175px] h-fit bg-white rounded shadow overflow-hidden">
      {tvshow.poster_path != undefined?<LazyImage
        src={`https://image.tmdb.org/t/p/w500${tvshow.poster_path}`}
        alt={tvshow.name}
        
      />:<div className="min-w-[175px] h-[262px] object-cover bg-gray-400 flex items-center"><h1 className="w-full text-center font-bold">{tvshow.name}</h1></div>}
